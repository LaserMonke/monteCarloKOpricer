...
with st.sidebar:
    ...
    with st.form("pricing_form", border=False):
        ...
        r = st.slider("Risk-free rate r — pricing drift under ℚ",
                      0.00, 0.15, 0.01, 0.0025)
        mu = st.slider("Real-world drift μ — diagnostics only",
                       -0.50, 0.50, 0.01, 0.01,
                       help="By no-arbitrage, μ never enters the price. It "
                            "only moves real-world statistics such as the "
                            "ℙ-measure knock-out probability.")
...
<div class="ticket">
  ...
  <div class="terms">
    ...
    <div class="term"><div class="k">VOL σ</div><div class="v">{sigma:.0%}</div></div>
